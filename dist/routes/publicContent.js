...
publicContentRouter.post("/eligibility/check", async (req, res, next) => {
  try {
    ...
    const {
      upsertMarketingLead: upsertMarketingLead2,
    ...
    const engineInput = {
      ...
      pincode: input.pincode || void 0,
      pinCode: input.pincode || void 0,
      currentPincode: input.pincode || void 0,
      permanentPincode: input.permanentPincode || void 0,
      propertyPincode: input.propertyPincode || void 0
    };
    ...
    const pool = getPool();
    const { row, created } = await upsertMarketingLead2(pool, {
      fullName: input.customerName,
