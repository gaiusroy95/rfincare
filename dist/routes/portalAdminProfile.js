...
const portalAdminProfileRouter = Router();
  ...
  try {
    ...
    if (verifiers.length < 3) {
      return res.status(400).json({
        error: "All three verifier emails must be configured in Settings (super admin) or via ADMIN_VERIFIER_EMAIL_1/2/3"
      });
    }
