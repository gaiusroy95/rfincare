...
async function ensureEngagementNotifications(pool, customerId, email) {
  const created = [];
...
async function runEngagementNotificationBatch(pool, { limit = 50 } = {}) {
...
export {
  ensureEngagementNotifications,
  runEngagementNotificationBatch
};
