...
async function autoAssignApplicationsForEmployeeVerification(pool) {
...
async function fetchEmployeeOwnedApplicationIds(pool, employeeId, { autoAssign = true } = {}) {
  if (autoAssign) {
...
export {
  ...
  autoAssignPendingAgentsToEmployees,
  fetchEmployeeOwnedApplicationIds,
  normalizeAgentCode,
  resolveResponsibleEmployeeIdForStage,
  stagePriorityOrder
};
