const GOVERNMENT_SCHEME_CATEGORIES = [
...
const GOVERNMENT_SCHEME_CATEGORY_SLUGS = GOVERNMENT_SCHEME_CATEGORIES.map((c) => c.slug);
...
function getGovernmentSchemeTaxonomy() {
  return {
...
export {
  ...
  GOVERNMENT_SCHEME_CATEGORIES,
  GOVERNMENT_SCHEME_CATEGORY_SLUGS,
  getCategoryLabel,
