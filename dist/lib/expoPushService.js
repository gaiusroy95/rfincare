...
async function getUserNotificationPreferences(userId) {
  ...
  try {
    ...
    const raw = typeof row.notification_preferences === "string" ? JSON.parse(row.notification_preferences) : row.notification_preferences;
...
async function unregisterPushToken(expoPushToken) {
