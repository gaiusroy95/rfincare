...
async function findAgentUserIdByCode(pool, agentCode) {
...
async function recordAgentCommission(pool, {
  agentUserId,
  agentCode,
  sourceType,
  sourceId,
...
async function fetchAgentCommissionLedger(pool, agentUserId, { limit = 50 } = {}) {
  try {
...
function mapLedgerEntryToCommission(row, { insuranceOrders = [], sipOrders = [] } = {}) {
