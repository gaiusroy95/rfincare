...
const BASE_CATEGORY_SLUGS = /* @__PURE__ */ new Set(["personal", "home", "business", "auto", "education"]);
...
function getProductCategoryFields(product) {
  ...
  return {
    ...
    categorySlug: normalizeKey(
      d.product_category_slug || d.productCategorySlug || d.catalog_slug || d.catalogSlug || ""
    ),
...
async function resolveProductCategoryQuery(pool, rawQuery) {
...
function bankProductMatchesCategory(product, category) {
