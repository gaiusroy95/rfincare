...
const CREDIT_CARD_CATEGORY_SLUGS = CREDIT_CARD_CATEGORIES.map((c) => c.slug);
const CREDIT_CARD_COMPARISON_FILTERS = [
...
const ANNUAL_FEE_FILTER_OPTIONS = [
...
export {
  ...
  CREDIT_CARD_COMPARISON_FILTERS,
