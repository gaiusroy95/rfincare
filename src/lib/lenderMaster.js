...
export async function ensureLenderMasterSchema(pool = getPool()) {
...
export async function listLenderBranches(bankId) {
...
export async function createLenderBranch(bankId, data) {
  await ensureLenderMasterSchema();
  const pool = getPool();
  const id = newId();
  await pool.execute(
...
export async function updateLenderBranch(branchId, data) {
  await ensureLenderMasterSchema();
  const pool = getPool();
  await pool.execute(
...
export async function deleteLenderBranch(branchId) {
  await ensureLenderMasterSchema();
  const pool = getPool();
...
export async function listLenderContacts(bankId) {
  await ensureLenderMasterSchema();
  const pool = getPool();
  const [rows] = await pool.query(
...
export async function createLenderContact(bankId, data) {
  await ensureLenderMasterSchema();
  const pool = getPool();
  const id = newId();
  if (data.isPrimary) {
...
export async function updateLenderContact(contactId, data) {
  await ensureLenderMasterSchema();
  const pool = getPool();
...
export async function deleteLenderContact(contactId) {
  await ensureLenderMasterSchema();
  const pool = getPool();
